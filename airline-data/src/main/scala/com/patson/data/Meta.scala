...
object Meta {
  ...
  def createSchema() {
    ...
    statement = connection.prepareStatement("CREATE TABLE " + AIRLINE_TABLE + "( id INTEGER PRIMARY KEY AUTO_INCREMENT, name VARCHAR(256), airline_type TINYINT(1), ai_type TINYINT(1))")
    statement.execute()
    statement.close()
