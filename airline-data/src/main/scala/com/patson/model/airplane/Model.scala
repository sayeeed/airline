...
object Model {
  ...
  val models = List(
    ...
    Model("Airbus A321neoXLR",	"Airbus A320",	230,	8,	1.7,	1.03,	828,	8400,	237744954,	1820,	36,	Manufacturer("Airbus",	"NL"),	2400,	"https://www.norebbo.com/2018/10/airbus-a321neo-lr-long-range-blank-illustration-templates/"),
    Model("Airbus A319neo",	"Airbus A320",	160,	7,	1.12,	1.18,	828,	4900,	140052025,	1820,	20,	Manufacturer("Airbus",	"NL"),	2164,	"https://www.norebbo.com/2017/09/airbus-a319-neo-blank-illustration-templates/"),
    Model("Airbus A320neo",	"Airbus A320",	195,	7,	1.03,	1.11,	833,	5646,	178548934,	1820,	24,	Manufacturer("Airbus",	"NL"),	2100,	"https://www.norebbo.com/2017/08/airbus-a320-neo-blank-illustration-templates/"),
    Model("Airbus A321neo",	"Airbus A320",	244,	7,	1.06,	1.09,	828,	5450,	213933870,	1820,	36,	Manufacturer("Airbus",	"NL"),	1988,	"https://www.norebbo.com/2017/09/airbus-a321-neo-blank-illustration-templates/"),
    Model("Airbus A321neoLR",	"Airbus A320",	230,	7,	1.6,	1.08,	828,	7200,	215908152,	1820,	36,	Manufacturer("Airbus",	"NL"),	2300,	"https://www.norebbo.com/2018/10/airbus-a321neo-lr-long-range-blank-illustration-templates/"),
    Model("Airbus A318",	"Airbus A320",	136,	6,	1.43,	1.52,	829,	5569,	65500862,	1820,	8,	Manufacturer("Airbus",	"NL"),	1780,	"https://www.norebbo.com/airbus-a318-blank-illustration-templates-with-pratt-whitney-and-cfm56-engines/"),
    Model("Airbus A319",	"Airbus A320",	160,	6,	1.41,	1.44,	830,	4862,	83425244,	1820,	16,	Manufacturer("Airbus",	"NL"),	1850,	"https://www.norebbo.com/2014/05/airbus-a319-blank-illustration-templates/"),
    Model("Airbus A320",	"Airbus A320",	195,	6,	1.38,	1.37,	828,	5408,	109000668,	1820,	20,	Manufacturer("Airbus",	"NL"),	2050,	"https://www.norebbo.com/2013/08/airbus-a320-blank-illustration-templates/"),
    ...
    Model("CASA CN-235",	"CASA",	40,	4,	1.45,	2.75,	460,	3658,	3579668,	1560,	0,	Manufacturer("CASA",	"ES"),	1204,	""),
    Model("CASA C-212 Aviocar",	"CASA",	26,	3,	1.28,	2.97,	354,	2680,	1826494,	1560,	0,	Manufacturer("CASA",	"ES"),	600,	""),
    Model("Cessna Caravan",	"Cessna",	14,	7,	0.88,	2.73,	355,	1680,	1283074,	1820,	0,	Manufacturer("Cessna",	"US"),	762,	"https://www.norebbo.com/2017/06/cessna-208-grand-caravan-blank-illustration-templates/"),
    ...
    Model("Embraer E175-E2",	"Embraer E-Jet",	88,	7,	1.14,	1.55,	833,	3650,	51741604,	1560,	6,	Manufacturer("Embraer",	"BR"),	1800,	"https://www.norebbo.com/2019/03/e175-e2-side-view/"),
    Model("Embraer E190-E2",	"Embraer E-Jet",	114,	7,	1.18,	1.42,	833,	4620,	75729741,	1560,	8,	Manufacturer("Embraer",	"BR"),	1465,	"https://www.norebbo.com/2019/03/e190-e2-blank-side-view/"),
    Model("Embraer E195-E2",	"Embraer E-Jet",	146,	7,	1.16,	1.4,	833,	4511,	99071643,	1560,	12,	Manufacturer("Embraer",	"BR"),	1605,	"https://www.norebbo.com/2019/03/embraer-e195-e2-side-view/"),
    Model("Embraer E170",	"Embraer E-Jet",	72,	6,	1.45,	1.71,	797,	2400,	24315584,	1560,	2,	Manufacturer("Embraer",	"BR"),	1438,	"https://www.norebbo.com/embraer-erj-175-templates-with-the-new-style-winglets/"),
    Model("Embraer E175 LR",	"Embraer E-Jet",	78,	6,	1.57,	1.67,	797,	2900,	29585397,	1560,	4,	Manufacturer("Embraer",	"BR"),	1420,	"https://www.norebbo.com/2015/10/embraer-erj-175-templates-with-the-new-style-winglets/"),
    Model("Embraer E190",	"Embraer E-Jet",	100,	6,	1.41,	1.79,	829,	3685,	33725955,	1560,	8,	Manufacturer("Embraer",	"BR"),	1650,	"https://www.norebbo.com/2015/06/embraer-190-blank-illustration-templates/"),
    Model("Embraer ERJ 145XR",	"Embraer E-Jet",	50,	6,	1.54,	2.3,	854,	3450,	11486988,	1560,	4,	Manufacturer("Embraer",	"BR"),	1720,	"https://www.norebbo.com/2018/04/embraer-erj-145xr-blank-illustration-templates/"),
    Model("Embraer ERJ 135LR",	"Embraer E-Jet",	37,	5,	1.48,	2.35,	833,	2854,	7853220,	1560,	4,	Manufacturer("Embraer",	"BR"),	1580,	"https://www.norebbo.com/2018/05/embraer-erj-135-blank-illustration-templates/"),
    Model("Airbus H225 Eurocopter",	"Eurocopter",	24,	8,	1.46,	3.27,	262,	857,	3264673,	1560,	8,	Manufacturer("Airbus",	"NL"),	1,	""),
    Model("Fokker 100",	"Fokker",	109,	4,	1.29,	1.7,	845,	2220,	28910255,	1300,	4,	Manufacturer("Fokker",	"NL"),	1550,	"https://www.norebbo.com/2018/07/fokker-100-f-28-0100-blank-illustration-templates/"),
    Model("Fokker 50",	"Fokker",	56,	3,	1.6,	2.46,	500,	2310,	3830417,	1300,	2,	Manufacturer("Fokker",	"NL"),	1550,	"https://www.norebbo.com/fokker-70-blank-illustration-templates/"),
    Model("Fokker 60",	"Fokker",	64,	3,	1.64,	2.41,	515,	2950,	4634011,	1300,	2,	Manufacturer("Fokker",	"NL"),	1550,	"https://www.norebbo.com/fokker-70-blank-illustration-templates/"),
    Model("Fokker 70",	"Fokker",	85,	3,	1.2,	1.82,	845,	2840,	17350688,	1300,	6,	Manufacturer("Fokker",	"NL"),	1480,	"https://www.norebbo.com/fokker-70-blank-illustration-templates/"),
    Model("Fokker F27 Friendship",	"Fokker",	44,	2,	1.31,	2.97,	460,	1380,	2923732,	1300,	4,	Manufacturer("Fokker",	"NL"),	1550,	""),
    Model("Harbin Y-12",	"Harbin Y",	12,	5,	0.84,	2.73,	250,	1140,	1874900,	1664,	4,	Manufacturer("Harbin",	"CN"),	720,	""),
    Model("Airlander 10",	"HAV Airlander",	130,	10,	0,	0.13,	178,	3400,	17066023,	780,	20,	Manufacturer("HAV Airlander",	"GB"),	100,	""),
    ...
    Model("Bombardier Global 7500",	"Modern Business Jet",	35,	10,	1.82,	1.82,	1080,	14260,	23207779,	1820,	8,	Manufacturer("Bombardier",	"CA"),	1768,	"https://www.norebbo.com/bombardier-global-7500-side-view/"),
    ...
    Model("Boeing 307 Stratoliner",	"Post-War Props",	60,	1,	2.08,	2.97,	357,	3850,	3627388,	1508,	8,	Manufacturer("Boeing",	"US"),	805,	""),
    ...
    Model("Lockheed Constellation L-749",	"Post-War Props",	81,	1,	3.13,	2.34,	555,	8039,	4257531,	1820,	12,	Manufacturer("Lockheed",	"US"),	1524,	""),
    ...
    Model("Saab 90 Scandia",	"Saab Regional",	32,	2,	1.5,	2.65,	340,	2650,	2265157,	1820,	0,	Manufacturer("Saab",	"SE"),	850,	""),
    Model("Sikorsky S-92",	"Sikorsky",	25,	10,	1.34,	3.26,	290,	998,	4078169,	1560,	2,	Manufacturer("Sikorsky",	"US"),	1,	""),
    Model("Sikorsky S-76",	"Sikorsky",	12,	9,	1.38,	3.22,	287,	761,	1408826,	1560,	2,	Manufacturer("Sikorsky",	"US"),	1,	""),
