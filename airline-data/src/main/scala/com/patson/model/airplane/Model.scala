...
Model("Antonov An-10A",	"Antonov An",	130,	1,	1.71,	3.33,	680,	1300,	13270066,	1456,	8,	Manufacturer("Antonov",	"UA"),	975,	""),
Model("Antonov An-148",	"Antonov An",	85,	5,	1.22,	1.94,	835,	3500,	17394188,	1040,	6,	Manufacturer("Antonov",	"UA"),	1100,	""),
Model("Antonov An-24",	"Antonov An",	50,	1,	1.48,	3.43,	450,	680,	3357438,	1456,	4,	Manufacturer("Antonov",	"UA"),	970,	""),
Model("Antonov An-72",	"Antonov An",	52,	3,	1.74,	2.9,	700,	2600,	7269070,	1456,	4,	Manufacturer("Antonov",	"UA"),	700,	""),
Model("ATR 42-400",	"ATR-Regional",	48,	4,	0.98,	3.03,	484,	1420,	4738595,	1040,	0,	Manufacturer("ATR",	"FR"),	1050,	"https://www.norebbo.com/atr-42-blank-illustration-templates/"),
Model("ATR 42-600S",	"ATR-Regional",	48,	5,	1.01,	2.96,	535,	1260,	6875186,	1040,	0,	Manufacturer("ATR",	"FR"),	750,	"https://www.norebbo.com/atr-42-blank-illustration-templates/"),
Model("ATR 72-200",	"ATR-Regional",	68,	4,	1.01,	2.53,	517,	1464,	9650818,	1040,	0,	Manufacturer("ATR",	"FR"),	1211,	"https://www.norebbo.com/2017/04/atr-72-blank-illustration-templates/"),
Model("ATR 72-600",	"ATR-Regional",	72,	5,	0.93,	2.52,	510,	1655,	10748896,	1040,	4,	Manufacturer("ATR",	"FR"),	1279,	"https://www.norebbo.com/2017/04/atr-72-blank-illustration-templates/"),
Model("Aurora D8",	"Aurora D",	188,	9,	1.1,	0.84,	937,	5200,	229175749,	1820,	36,	Manufacturer("Aurora Flight Sciences",	"US"),	2300,	""),
Model("BAe 146-100",	"BAe 146",	82,	4,	1.26,	2.49,	747,	2090,	11510446,	1560,	2,	Manufacturer("BAe",	"GB"),	1195,	"https://www.norebbo.com/2018/11/british-aerospace-bae-146-200-avro-rj85-blank-illustration-templates/"),
Model("BAe 146-200",	"BAe 146",	100,	4,	1.16,	2.33,	747,	1800,	13859843,	1560,	2,	Manufacturer("BAe",	"GB"),	1390,	"https://www.norebbo.com/2018/11/british-aerospace-bae-146-200-avro-rj85-blank-illustration-templates/"),
Model("BAe 146-300",	"BAe 146",	112,	4,	1.11,	2.26,	747,	1650,	15430077,	1560,	2,	Manufacturer("BAe",	"GB"),	1535,	"https://www.norebbo.com/2018/11/british-aerospace-bae-146-200-avro-rj85-blank-illustration-templates/"),
...
Model("Boeing 2707",	"Boeing 2707",	247,	8,	3.88,	5.1,	3300,	5600,	665092707,	1664,	42,	Manufacturer("Boeing",	"US"),	3590,	""),
...
Model("Boeing 707-120",	"Boeing 707",	194,	3,	2.18,	2.31,	952,	5100,	17726440,	2496,	16,	Manufacturer("Boeing",	"US"),	2700,	""),
Model("Boeing 707-320",	"Boeing 707",	189,	3,	2.99,	2.1,	952,	8200,	19866933,	2496,	16,	Manufacturer("Boeing",	"US"),	3150,	"https://www.norebbo.com/boeing-707-320c-blank-illustration-templates/"),
...
Model("Boeing 737-200",	"Boeing 737",	136,	4,	1.63,	2.06,	780,	3693,	21624929,	1976,	12,	Manufacturer("Boeing",	"US"),	1859,	"https://www.norebbo.com/2018/09/boeing-737-200-blank-illustration-templates/"),
Model("Boeing 737-300",	"Boeing 737",	144,	4,	1.39,	1.91,	800,	4128,	34551670,	1976,	16,	Manufacturer("Boeing",	"US"),	2010,	"https://www.norebbo.com/2018/09/boeing-737-300-blank-illustration-templates/"),
Model("Boeing 737-400",	"Boeing 737",	168,	4,	1.31,	1.67,	800,	4105,	51243943,	1976,	16,	Manufacturer("Boeing",	"US"),	2540,	"https://www.norebbo.com/2018/09/boeing-737-400-blank-illustration-templates/"),
...
Model("Bombardier CRJ100",	"Bombardier CRJ",	50,	5,	1.25,	2.6,	830,	1820,	17329143,	1820,	0,	Manufacturer("Bombardier",	"CA"),	1920,	"https://www.norebbo.com/2015/04/bombardier-canadair-regional-jet-200-blank-illustration-templates/"),
Model("Bombardier CRJ1000",	"Bombardier CRJ",	104,	5,	1.03,	1.91,	870,	1600,	43387101,	1820,	8,	Manufacturer("Bombardier",	"CA"),	2120,	"https://www.norebbo.com/2019/06/bombardier-crj-1000-side-view/"),
Model("Bombardier CRJ200",	"Bombardier CRJ",	50,	5,	1.21,	2.51,	830,	2813,	18252079,	1820,	0,	Manufacturer("Bombardier",	"CA"),	1920,	"https://www.norebbo.com/2015/04/bombardier-canadair-regional-jet-200-blank-illustration-templates/"),
Model("Bombardier CRJ700",	"Bombardier CRJ",	78,	5,	1.15,	2.29,	828,	2480,	28027633,	1820,	4,	Manufacturer("Bombardier",	"CA"),	1605,	"https://www.norebbo.com/2015/05/bombardier-canadair-regional-jet-700-blank-illustration-templates/"),
Model("Bombardier CRJ900",	"Bombardier CRJ",	90,	5,	1.18,	1.98,	870,	2931,	42465168,	1820,	8,	Manufacturer("Bombardier",	"CA"),	1939,	"https://www.norebbo.com/2016/07/bombardier-canadair-regional-jet-900-blank-illustration-templates/"),
...
Model("Boom Overture",	"Boom Overture",	128,	10,	2.7,	3.12,	1800,	7870,	416583249,	1664,	100,	Manufacturer("Boom Technology",	"US"),	3048,	""),
Model("Bristol Britannia",	"Post-War Props",	139,	1,	2.77,	2.1,	575,	6400,	10849458,	1820,	2,	Manufacturer("BAe",	"GB"),	2225,	""),
Model("CASA C-212 Aviocar",	"CASA",	26,	3,	1.23,	2.97,	354,	2680,	2009144,	1560,	0,	Manufacturer("CASA",	"ES"),	600,	""),
Model("CASA CN-235",	"CASA",	40,	4,	1.39,	2.75,	460,	3658,	3937635,	1560,	0,	Manufacturer("CASA",	"ES"),	1204,	""),
...
Model("Comac C919-100 ER",	"Comac C919",	168,	6,	1.21,	1.4,	838,	4300,	87410290,	1560,	16,	Manufacturer("COMAC",	"CN"),	2000,	"https://www.norebbo.com/comac-c919-side-view/"),
Model("Comac C919-100 STD",	"Comac C919",	168,	6,	0.93,	1.46,	838,	2800,	77868739,	1560,	16,	Manufacturer("COMAC",	"CN"),	2000,	"https://www.norebbo.com/comac-c919-side-view/"),
...
Model("Lockheed L-1011-100",	"Lockheed TriStar",	400,	4,	1.58,	1.84,	963,	4200,	138104016,	2080,	16,	Manufacturer("Lockheed",	"US"),	2560,	"https://www.norebbo.com/lockheed-l-1011-1-blank-illustration-templates/"),
...
Model("McDonnell Douglas DC-10-10",	"DC-10",	410,	4,	2.02,	1.82,	876,	6500,	71152799,	1820,	16,	Manufacturer("McDonnell Douglas",	"US"),	2700,	"https://www.norebbo.com/mcdonnell-douglas-dc-10-30-blank-templates/"),
Model("McDonnell Douglas DC-10-30",	"DC-10",	410,	4,	2.41,	1.85,	886,	9400,	78224219,	1820,	20,	Manufacturer("McDonnell Douglas",	"US"),	3220,	"https://www.norebbo.com/mcdonnell-douglas-dc-10-30-blank-templates/"),
Model("McDonnell Douglas DC-10-40",	"DC-10",	410,	5,	2.55,	1.88,	886,	12392,	83407309,	1820,	24,	Manufacturer("McDonnell Douglas",	"US"),	2980,	"https://www.norebbo.com/mcdonnell-douglas-dc-10-30-blank-templates/"),
Model("McDonnell Douglas DC-8-61",	"DC-8",	259,	3,	2.43,	2.28,	895,	6200,	25929328,	2496,	24,	Manufacturer("McDonnell Douglas",	"US"),	2680,	"https://www.norebbo.com/douglas-dc-8-61-blank-illustration-templates/"),
Model("McDonnell Douglas DC-8-62",	"DC-8",	189,	3,	2.86,	2.22,	895,	9800,	29837950,	2496,	16,	Manufacturer("McDonnell Douglas",	"US"),	2680,	""),
Model("McDonnell Douglas DC-8-63",	"DC-8",	259,	3,	2.74,	2.29,	895,	8100,	29868744,	2496,	24,	Manufacturer("McDonnell Douglas",	"US"),	2680,	"https://www.norebbo.com/douglas-dc-8-73-and-dc-8-73cf-blank-illustration-templates/"),
...
Model("Mil Mi-26",	"Mil",	78,	0,	1.21,	2.7,	255,	870,	2349622,	780,	0,	Manufacturer("Mil",	"RU"),	1,	""),
...
Model("Tupolev Tu-154",	"Tupolev 154",	180,	3,	1.51,	2.95,	850,	2500,	14112505,	1664,	12,	Manufacturer("Tupolev",	"RU"),	1140,	"https://www.norebbo.com/tupolev-tu-154-side-view/"),
Model("Tupolev Tu-154M",	"Tupolev 154",	180,	4,	1.42,	2.48,	850,	5280,	17652617,	1664,	12,	Manufacturer("Tupolev",	"RU"),	1250,	"https://www.norebbo.com/tupolev-tu-154-side-view/"),
