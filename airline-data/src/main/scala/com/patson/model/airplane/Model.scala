...
object Model {
  ...
  val models = List(
    Model("Airbus A220-100",	"Airbus A220",	135,	8,	1.05,	1.33,	828,	3710,	106136677,	1820,	14,	Manufacturer("Airbus",	"NL"),	1483,	"https://www.norebbo.com/2016/02/bombardier-cs100-blank-illustration-templates/"),
    Model("Airbus A220-300",	"Airbus A220",	160,	8,	0.95,	1.28,	828,	4745,	135027402,	1820,	14,	Manufacturer("Airbus",	"NL"),	1890,	"https://www.norebbo.com/2016/02/bombardier-cs300-blank-illustration-templates/"),
    Model("Airbus A221",	"Airbus A220",	188,	8,	0.98,	1.16,	828,	4800,	175819119,	1820,	20,	Manufacturer("Airbus",	"NL"),	2000,	""),
    ...
    Model("Airbus A300B4",	"Airbus A300/A310",	320,	5,	1.4,	1.79,	847,	5375,	105875479,	1820,	32,	Manufacturer("Airbus",	"NL"),	2250,	"https://www.norebbo.com/2018/11/airbus-a300b4-600r-blank-illustration-templates-with-general-electric-engines/"),
    Model("Airbus A321neoXLR",	"Airbus A320",	230,	8,	1.7,	1.03,	828,	8400,	215768529,	1820,	36,	Manufacturer("Airbus",	"NL"),	2900,	"https://www.norebbo.com/2018/10/airbus-a321neo-lr-long-range-blank-illustration-templates/"),
    Model("Airbus A319neo",	"Airbus A320",	160,	7,	1.0752,	1.18,	828,	4900,	140052025,	1820,	20,	Manufacturer("Airbus",	"NL"),	1880,	"https://www.norebbo.com/2017/09/airbus-a319-neo-blank-illustration-templates/"),
    Model("Airbus A320neo",	"Airbus A320",	195,	7,	0.9888,	1.11,	833,	5646,	178548934,	1820,	24,	Manufacturer("Airbus",	"NL"),	1970,	"https://www.norebbo.com/2017/08/airbus-a320-neo-blank-illustration-templates/"),
    Model("Airbus A321neo",	"Airbus A320",	244,	7,	1.0176,	1.09,	828,	5450,	212120871,	1820,	36,	Manufacturer("Airbus",	"NL"),	2177,	"https://www.norebbo.com/2017/09/airbus-a321-neo-blank-illustration-templates/"),
    Model("Airbus A321neoLR",	"Airbus A320",	230,	7,	1.6,	1.08,	828,	7200,	203417597,	1820,	36,	Manufacturer("Airbus",	"NL"),	2495,	"https://www.norebbo.com/2018/10/airbus-a321neo-lr-long-range-blank-illustration-templates/"),
    ...
    Model("Airbus A320",	"Airbus A320",	195,	6,	1.38,	1.37,	828,	5408,	106820655,	1820,	20,	Manufacturer("Airbus",	"NL"),	2150,	"https://www.norebbo.com/2013/08/airbus-a320-blank-illustration-templates/"),
    ...
    Model("Airbus ZeroE Turboprop",	"Airbus ZE",	85,	9,	0.41,	0.56,	674,	1100,	81036498,	1040,	24,	Manufacturer("Airbus",	"NL"),	2000,	""),
    Model("Antonov An-148",	"Antonov An",	85,	5,	1.27,	1.94,	835,	3500,	16669430,	1040,	6,	Manufacturer("Antonov",	"UA"),	1100,	""),
    Model("Antonov An-72",	"Antonov An",	52,	3,	1.82,	2.9,	700,	2600,	7269070,	1456,	4,	Manufacturer("Antonov",	"UA"),	700,	""),
    Model("Antonov An-10A",	"Antonov An",	130,	1,	1.71,	3.33,	680,	1300,	12495979,	1456,	8,	Manufacturer("Antonov",	"UA"),	975,	""),
    Model("Antonov An-24",	"Antonov An",	50,	1,	1.51,	3.43,	450,	680,	3357438,	1456,	4,	Manufacturer("Antonov",	"UA"),	970,	""),
    Model("ATR 42-600S",	"ATR-Regional",	48,	5,	1.1,	2.96,	535,	1260,	5439498,	1040,	0,	Manufacturer("ATR",	"FR"),	750,	"https://www.norebbo.com/atr-42-blank-illustration-templates/"),
    Model("ATR 72-600",	"ATR-Regional",	72,	5,	1.01,	2.52,	510,	1655,	7653864,	1040,	4,	Manufacturer("ATR",	"FR"),	1279,	"https://www.norebbo.com/2017/04/atr-72-blank-illustration-templates/"),
    Model("ATR 42-400",	"ATR-Regional",	48,	4,	1.06,	3.03,	484,	1420,	4820238,	1040,	0,	Manufacturer("ATR",	"FR"),	1050,	"https://www.norebbo.com/atr-42-blank-illustration-templates/"),
    Model("ATR 72-200",	"ATR-Regional",	68,	4,	1.1,	2.53,	517,	1464,	6871967,	1040,	0,	Manufacturer("ATR",	"FR"),	1211,	"https://www.norebbo.com/2017/04/atr-72-blank-illustration-templates/"),
    Model("Aurora D8",	"Aurora D",	188,	9,	1.24,	0.84,	937,	5200,	229175749,	1820,	36,	Manufacturer("Aurora Flight Sciences",	"US"),	2300,	""),
    Model("BAe 146-100",	"BAe 146",	82,	4,	1.28,	2.49,	747,	2090,	12556851,	1560,	2,	Manufacturer("BAe",	"GB"),	1195,	"https://www.norebbo.com/2018/11/british-aerospace-bae-146-200-avro-rj85-blank-illustration-templates/"),
    Model("BAe 146-200",	"BAe 146",	100,	4,	1.18,	2.33,	747,	1800,	15119829,	1560,	2,	Manufacturer("BAe",	"GB"),	1390,	"https://www.norebbo.com/2018/11/british-aerospace-bae-146-200-avro-rj85-blank-illustration-templates/"),
    Model("BAe 146-300",	"BAe 146",	112,	4,	1.17,	2.26,	747,	1650,	16832811,	1560,	2,	Manufacturer("BAe",	"GB"),	1535,	"https://www.norebbo.com/2018/11/british-aerospace-bae-146-200-avro-rj85-blank-illustration-templates/"),
    ...
    Model("Boeing 707-120",	"Boeing 707",	194,	3,	2.87,	2.61,	952,	5100,	22158051,	2496,	16,	Manufacturer("Boeing",	"US"),	2700,	""),
    Model("Boeing 707-320",	"Boeing 707",	189,	3,	3.14,	2.27,	952,	8200,	24336992,	2496,	16,	Manufacturer("Boeing",	"US"),	3150,	"https://www.norebbo.com/boeing-707-320c-blank-illustration-templates/"),
    Model("Boeing 720B",	"Boeing 707",	165,	3,	2.07,	2.54,	896,	5700,	18904767,	1976,	12,	Manufacturer("Boeing",	"US"),	2000,	""),
    ...
    Model("Boeing 737 MAX 10",	"Boeing 737",	230,	7,	1.14,	1.2,	830,	5400,	175688906,	1820,	36,	Manufacturer("Boeing",	"US"),	2700,	"https://www.norebbo.com/2019/01/737-10-max-side-view/"),
    Model("Boeing 737 MAX 7",	"Boeing 737",	172,	7,	1.18,	1.27,	830,	6800,	127387988,	1820,	24,	Manufacturer("Boeing",	"US"),	2100,	"https://www.norebbo.com/2016/07/boeing-737-max-7-blank-illustration-templates/"),
    Model("Boeing 737 MAX 8",	"Boeing 737",	189,	7,	1.17,	1.25,	830,	6306,	140919761,	1820,	24,	Manufacturer("Boeing",	"US"),	2035,	"https://www.norebbo.com/2016/07/boeing-737-max-8-blank-illustration-templates/"),
    Model("Boeing 737 MAX 9",	"Boeing 737",	220,	7,	1.19,	1.22,	839,	5830,	163221248,	1820,	36,	Manufacturer("Boeing",	"US"),	2600,	"https://www.norebbo.com/2018/05/boeing-737-9-max-blank-illustration-templates/"),
    Model("Boeing 737 MAX 8-200",	"Boeing 737",	210,	6,	1.09,	1.23,	839,	4400,	140559722,	1820,	24,	Manufacturer("Boeing",	"US"),	2500,	"https://www.norebbo.com/2016/07/boeing-737-max-8-blank-illustration-templates/"),
    ...
    Model("Boeing 737-500",	"Boeing 737",	132,	5,	1.66,	1.84,	800,	4249,	39555791,	1976,	12,	Manufacturer("Boeing",	"US"),	2280,	"https://www.norebbo.com/2018/09/boeing-737-500-blank-illustration-templates-with-and-without-blended-winglets/"),
    Model("Boeing 737-600",	"Boeing 737",	130,	5,	1.57,	1.76,	834,	4681,	51870582,	1976,	16,	Manufacturer("Boeing",	"US"),	1804,	"https://www.norebbo.com/2018/09/boeing-737-600-blank-illustration-templates/"),
    ...
    Model("Boeing 737-200",	"Boeing 737",	136,	4,	1.84,	2.06,	780,	3693,	25437731,	1976,	12,	Manufacturer("Boeing",	"US"),	1859,	"https://www.norebbo.com/2018/09/boeing-737-200-blank-illustration-templates/"),
    Model("Boeing 737-300",	"Boeing 737",	144,	4,	1.57,	1.91,	800,	4128,	38691680,	1976,	16,	Manufacturer("Boeing",	"US"),	2010,	"https://www.norebbo.com/2018/09/boeing-737-300-blank-illustration-templates/"),
    Model("Boeing 737-400",	"Boeing 737",	168,	4,	1.48,	1.67,	800,	4105,	57422617,	1976,	16,	Manufacturer("Boeing",	"US"),	2540,	"https://www.norebbo.com/2018/09/boeing-737-400-blank-illustration-templates/"),
    Model("Boeing 737-100",	"Boeing 737",	124,	3,	2.05,	2.05,	780,	2850,	22218683,	1976,	8,	Manufacturer("Boeing",	"US"),	1800,	"https://www.norebbo.com/2018/10/boeing-737-100-blank-illustration-templates/"),
    Model("Boeing 747-8i",	"Boeing 747",	645,	7,	2.72,	1.04,	933,	13804,	543525791,	1820,	48,	Manufacturer("Boeing",	"US"),	3180,	"https://www.norebbo.com/2015/12/boeing-747-8i-blank-illustration-templates/"),
    Model("Boeing 747-400D",	"Boeing 747",	605,	6,	1.19,	1.12,	933,	2800,	387709570,	1820,	48,	Manufacturer("Boeing",	"US"),	2480,	"https://www.norebbo.com/2013/09/boeing-747-400-blank-illustration-templates/"),
    Model("Boeing 747-400ER",	"Boeing 747",	585,	6,	2.85,	1.18,	933,	13804,	419830259,	1820,	48,	Manufacturer("Boeing",	"US"),	3300,	"https://www.norebbo.com/2013/09/boeing-747-400-blank-illustration-templates/"),
    Model("Boeing 747SP",	"Boeing 747",	388,	6,	3.32,	1.66,	994,	12051,	164770934,	1820,	36,	Manufacturer("Boeing",	"US"),	2820,	"https://www.norebbo.com/2019/08/boeing-747sp-side-view/"),
    Model("Boeing 747-300",	"Boeing 747",	520,	5,	2.87,	1.54,	939,	11127,	220968680,	1820,	48,	Manufacturer("Boeing",	"US"),	2955,	"https://www.norebbo.com/boeing-747-300-side-view/"),
    Model("Boeing 747-100",	"Boeing 747",	520,	4,	3.51,	1.89,	907,	8530,	95886016,	1820,	36,	Manufacturer("Boeing",	"US"),	3250,	"https://www.norebbo.com/2019/07/boeing-747-100-side-view/"),
    ...
    Model("Boeing 757-300",	"Boeing 757",	295,	5,	2.01,	1.37,	850,	5742,	152515163,	1976,	36,	Manufacturer("Boeing",	"US"),	2400,	"https://www.norebbo.com/2017/03/boeing-757-300-blank-illustration-templates/"),
    ...
    Model("Boeing 767-200",	"Boeing 767",	245,	5,	1.74,	1.51,	860,	6240,	113278697,	1820,	36,	Manufacturer("Boeing",	"US"),	1900,	"https://www.norebbo.com/2014/07/boeing-767-200-blank-illustration-templates/"),
    ...
    Model("Boeing 767-300",	"Boeing 767",	290,	5,	1.58,	1.44,	860,	6800,	139109160,	1820,	36,	Manufacturer("Boeing",	"US"),	2800,	"https://www.norebbo.com/2014/07/boeing-767-200-blank-illustration-templates/"),
    ...
    Model("Boeing Vertol 107-II ",	"Boeing Vertol",	28,	4,	1.9,	3.15,	265,	1020,	2628160,	1300,	4,	Manufacturer("Boeing",	"US"),	1,	""),
    Model("Boeing Vertol 234",	"Boeing Vertol",	44,	4,	1.82,	3.11,	269,	1010,	3132192,	1300,	4,	Manufacturer("Boeing",	"US"),	1,	""),
    Model("Bombardier CRJ100",	"Bombardier CRJ",	50,	5,	1.3,	2.56,	830,	1820,	13430085,	1820,	0,	Manufacturer("Bombardier",	"CA"),	1920,	"https://www.norebbo.com/2015/04/bombardier-canadair-regional-jet-200-blank-illustration-templates/"),
    Model("Bombardier CRJ1000",	"Bombardier CRJ",	104,	5,	1.12,	1.87,	870,	1600,	41885551,	1820,	8,	Manufacturer("Bombardier",	"CA"),	2120,	"https://www.norebbo.com/2019/06/bombardier-crj-1000-side-view/"),
    Model("Bombardier CRJ200",	"Bombardier CRJ",	50,	5,	1.26,	2.44,	830,	2813,	14145361,	1820,	0,	Manufacturer("Bombardier",	"CA"),	1920,	"https://www.norebbo.com/2015/04/bombardier-canadair-regional-jet-200-blank-illustration-templates/"),
    Model("Bombardier CRJ700",	"Bombardier CRJ",	78,	5,	1.2,	2.2,	828,	2480,	21721415,	1820,	4,	Manufacturer("Bombardier",	"CA"),	1605,	"https://www.norebbo.com/2015/05/bombardier-canadair-regional-jet-700-blank-illustration-templates/"),
    Model("Bombardier CRJ900",	"Bombardier CRJ",	90,	5,	1.23,	1.93,	870,	2931,	35542794,	1820,	8,	Manufacturer("Bombardier",	"CA"),	1939,	"https://www.norebbo.com/2016/07/bombardier-canadair-regional-jet-900-blank-illustration-templates/"),
    ...
    Model("Comac C909 ER",	"Comac C909",	90,	5,	1.62,	2.3,	828,	3200,	18071436,	1560,	8,	Manufacturer("COMAC",	"CN"),	1780,	""),
    Model("Comac C909 STD",	"Comac C909",	90,	5,	1.29,	2.36,	828,	2040,	17027885,	1560,	8,	Manufacturer("COMAC",	"CN"),	1700,	""),
    ...
    Model("Convair 880",	"Convair",	110,	4,	2.35,	1.92,	880,	5636,	24740184,	1820,	4,	Manufacturer("Convair",	"US"),	2670,	""),
    Model("Convair 990 Coronado",	"Convair",	121,	4,	2.64,	2.14,	990,	6116,	28211714,	1820,	8,	Manufacturer("Convair",	"US"),	2875,	""),
    Model("Convair 990A Coronado",	"Convair",	149,	5,	2.83,	2.24,	1030,	6116,	33424230,	1820,	12,	Manufacturer("Convair",	"US"),	3002,	""),
    Model("Dassault Mercure",	"Dassault",	162,	2,	2.08,	2.14,	926,	1684,	19667961,	1820,	12,	Manufacturer("Dassault Aviation",	"FR"),	2100,	""),
    ...
    Model("McDonnell Douglas DC-8-61",	"DC-8",	259,	3,	2.79,	2.38,	895,	6200,	27584392,	2496,	24,	Manufacturer("McDonnell Douglas",	"US"),	2680,	"https://www.norebbo.com/douglas-dc-8-61-blank-illustration-templates/"),
    Model("McDonnell Douglas DC-8-62",	"DC-8",	189,	3,	2.95,	2.22,	895,	9800,	31081197,	2496,	16,	Manufacturer("McDonnell Douglas",	"US"),	2680,	""),
    Model("McDonnell Douglas DC-8-63",	"DC-8",	259,	3,	2.85,	2.39,	895,	8100,	31113275,	2496,	24,	Manufacturer("McDonnell Douglas",	"US"),	2680,	"https://www.norebbo.com/douglas-dc-8-73-and-dc-8-73cf-blank-illustration-templates/"),
    Model("Douglas DC-8-10",	"DC-8",	177,	2,	2.7,	2.79,	895,	3760,	15222727,	2496,	16,	Manufacturer("Douglas Aircraft Company",	"US"),	2840,	""),
    Model("Douglas DC-8-53",	"DC-8",	189,	2,	2.79,	2.63,	895,	8700,	19666651,	2496,	16,	Manufacturer("Douglas Aircraft Company",	"US"),	3200,	"https://www.norebbo.com/douglas-dc-8-53-blank-illustration-templates/"),
    ...
    Model("McDonnell Douglas MD-90",	"DC-9",	171,	5,	1.2288,	1.79,	830,	1400,	43169047,	1560,	20,	Manufacturer("McDonnell Douglas",	"US"),	2134,	"https://www.norebbo.com/2018/02/mcdonnell-douglas-md-90-blank-illustration-templates/"),
    Model("McDonnell Douglas MD-90ER",	"DC-9",	163,	5,	1.2672,	1.75,	830,	3300,	47595620,	1560,	20,	Manufacturer("McDonnell Douglas",	"US"),	2134,	"https://www.norebbo.com/2018/02/mcdonnell-douglas-md-90-blank-illustration-templates/"),
    Model("McDonnell Douglas MD-81",	"DC-9",	161,	4,	1.4208,	1.95,	830,	2600,	32130061,	1560,	12,	Manufacturer("McDonnell Douglas",	"US"),	2070,	"https://www.norebbo.com/2015/02/mcdonnell-douglas-md-80-blank-illustration-templates/"),
    Model("McDonnell Douglas MD-85",	"DC-9",	135,	4,	1.4496,	1.98,	830,	2500,	25493232,	1560,	12,	Manufacturer("McDonnell Douglas",	"US"),	1840,	"https://www.norebbo.com/2015/02/mcdonnell-douglas-md-80-blank-illustration-templates/"),
    Model("McDonnell Douglas DC-9-50",	"DC-9",	139,	3,	1.536,	2.07,	804,	3030,	13836414,	1040,	4,	Manufacturer("McDonnell Douglas",	"US"),	2100,	"https://www.norebbo.com/dc-9-50-side-view/"),
    Model("McDonnell Douglas DC-9-10",	"DC-9",	92,	2,	1.7376,	2.21,	965,	2367,	8917883,	1040,	4,	Manufacturer("McDonnell Douglas",	"US"),	1816,	""),
    Model("McDonnell Douglas DC-9-30",	"DC-9",	115,	2,	1.6896,	2.14,	804,	2778,	9778738,	1040,	4,	Manufacturer("McDonnell Douglas",	"US"),	1900,	"https://www.norebbo.com/mcdonnell-douglas-dc-9-30-templates/"),
    Model("De Havilland Q400",	"DHC Dash",	86,	5,	1.02,	2.1,	562,	2040,	11293640,	1560,	8,	Manufacturer("De Havilland Canada",	"CA"),	1885,	"https://www.norebbo.com/bombardier-dhc-8-402-q400-blank-illustration-templates/"),
    Model("De Havilland DHC-8-100",	"DHC Dash",	39,	4,	1.31,	2.7,	448,	1889,	5156573,	1820,	2,	Manufacturer("De Havilland Canada",	"CA"),	950,	"https://www.norebbo.com/2018/01/de-havilland-dhc-8-200-dash-8-blank-illustration-templates/"),
    Model("De Havilland DHC-8-200",	"DHC Dash",	39,	4,	1.31,	2.6145,	448,	2084,	5209110,	1820,	2,	Manufacturer("De Havilland Canada",	"CA"),	1000,	"https://www.norebbo.com/2018/01/de-havilland-dhc-8-200-dash-8-blank-illustration-templates/"),
    Model("De Havilland DHC-8-300",	"DHC Dash",	50,	4,	1.35,	2.4045,	450,	1711,	6582530,	1820,	4,	Manufacturer("De Havilland Canada",	"CA"),	1085,	"https://www.norebbo.com/2018/05/de-havilland-dhc-8-300-blank-illustration-templates/"),
    Model("De Havilland DHC-8-400",	"DHC Dash",	68,	4,	1.31,	2.184,	667,	1980,	10601120,	1560,	4,	Manufacturer("De Havilland Canada",	"CA"),	1085,	"https://www.norebbo.com/bombardier-dhc-8-402-q400-blank-illustration-templates/"),
    Model("De Havilland DHC-7-100",	"DHC Dash",	50,	3,	1.35,	2.82,	428,	1300,	5891316,	1820,	4,	Manufacturer("De Havilland Canada",	"CA"),	620,	""),
    Model("Dornier 328eco",	"Dornier",	44,	9,	0,	0.43,	600,	690,	33224671,	1300,	8,	Manufacturer("Dornier",	"DE"),	1367,	""),
    Model("Dornier 1128",	"Dornier",	128,	7,	1.4,	1.79,	923,	2640,	42533993,	1300,	12,	Manufacturer("Dornier",	"DE"),	1550,	""),
    Model("Dornier 328-110",	"Dornier",	33,	7,	1.27,	2.38,	620,	820,	7236839,	1820,	6,	Manufacturer("Dornier",	"DE"),	1088,	"https://www.norebbo.com/2019/01/dornier-328-110-blank-illustration-templates/"),
    Model("Dornier 328JET",	"Dornier",	44,	7,	1.7,	2.12,	740,	1150,	10776307,	1820,	6,	Manufacturer("Dornier",	"DE"),	1367,	"https://www.norebbo.com/2019/01/fairchild-dornier-328jet-illustrations/"),
    Model("Dornier 728",	"Dornier",	80,	7,	1.64,	1.95,	1000,	2340,	36459603,	1820,	6,	Manufacturer("Dornier",	"DE"),	1463,	""),
    Model("Dornier 928",	"Dornier",	110,	7,	1.55,	1.82,	951,	2180,	35117583,	1300,	8,	Manufacturer("Dornier",	"DE"),	1513,	""),
    ...
    Model("Embraer E195-E2",	"Embraer",	146,	7,	1.16,	1.4,	833,	4511,	91995097,	1560,	12,	Manufacturer("Embraer",	"BR"),	1605,	"https://www.norebbo.com/2019/03/embraer-e195-e2-side-view/"),
    ...
    Model("Embraer ERJ 145XR",	"Embraer",	50,	6,	1.54,	2.3,	854,	3450,	12865426,	1560,	4,	Manufacturer("Embraer",	"BR"),	1720,	"https://www.norebbo.com/2018/04/embraer-erj-145xr-blank-illustration-templates/"),
    Model("Embraer ERJ 135LR",	"Embraer",	37,	5,	1.48,	2.35,	833,	2854,	8698951,	1560,	4,	Manufacturer("Embraer",	"BR"),	1580,	"https://www.norebbo.com/2018/05/embraer-erj-135-blank-illustration-templates/"),
    Model("Embraer EMB 120",	"Embraer",	30,	4,	1.54,	2.65,	552,	1550,	3671306,	1300,	2,	Manufacturer("Embraer",	"BR"),	980,	""),
    Model("Airbus H225 Eurocopter",	"Eurocopter",	15,	8,	1.36,	3.27,	262,	857,	2038061,	1560,	8,	Manufacturer("Airbus",	"NL"),	1,	""),
    ...
    Model("Fokker 50",	"Fokker",	56,	4,	1.6,	2.46,	500,	2310,	3818595,	1300,	2,	Manufacturer("Fokker",	"NL"),	1550,	"https://www.norebbo.com/fokker-70-blank-illustration-templates/"),
    Model("Fokker 60",	"Fokker",	64,	4,	1.64,	2.41,	515,	2950,	4619708,	1300,	2,	Manufacturer("Fokker",	"NL"),	1550,	"https://www.norebbo.com/fokker-70-blank-illustration-templates/"),
    ...
    Model("Fokker F27 Friendship",	"Fokker",	44,	3,	1.31,	2.97,	460,	1380,	2691162,	1300,	4,	Manufacturer("Fokker",	"NL"),	1550,	""),
    Model("Harbin Y-12",	"Harbin Y",	12,	5,	0.96,	2.43,	310,	1140,	2153675,	1664,	4,	Manufacturer("Harbin",	"CN"),	720,	""),
    ...
    Model("Ilyushin Il-96-300",	"Ilyushin Il-96",	300,	5,	2.98,	2.02,	870,	10100,	44084516,	1456,	18,	Manufacturer("Ilyushin",	"RU"),	3200,	""),
    Model("Ilyushin Il-86",	"Ilyushin Il-96",	350,	4,	2.46,	2.19,	870,	4400,	43123255,	1456,	16,	Manufacturer("Ilyushin",	"RU"),	2800,	""),
    Model("Lockheed L-188 Electra",	"Lockheed Props",	98,	1,	0.93,	2.77,	620,	3100,	14842120,	1820,	2,	Manufacturer("Lockheed",	"US"),	980,	""),
    Model("Lockheed L-749 Constellation",	"Lockheed Props",	81,	1,	3.33,	2.44,	490,	8039,	3215091,	1560,	8,	Manufacturer("Lockheed",	"US"),	1524,	""),
    Model("Lockheed L-1649 Starliner",	"Lockheed Props",	99,	2,	3.56,	2.29,	490,	7950,	5388288,	1560,	8,	Manufacturer("Lockheed",	"US"),	1610,	""),
    ...
    Model("Bombardier Global 5000",	"Modern Business Jet",	30,	10,	1.67,	2.11,	934,	9630,	13865044,	1820,	8,	Manufacturer("Bombardier",	"CA"),	1689,	"https://www.norebbo.com/bombardier-global-5000-blank-illustration-templates/"),
    ...
    Model("Cessna Citation X",	"Modern Business Jet",	20,	10,	1.85,	2.3,	900,	6050,	6830863,	1820,	8,	Manufacturer("Cessna",	"US"),	1600,	"https://www.norebbo.com/cessna-citation-x-template/"),
    Model("Gulfstream G650ER",	"Modern Business Jet",	40,	10,	1.72,	2.12,	966,	13890,	19254915,	2080,	8,	Manufacturer("Gulfstream",	"US"),	1920,	"https://www.norebbo.com/gulfstream-g650er-template/"),
    Model("Boeing 377 Stratocruiser",	"Post-War Props",	117,	1,	2.9,	2.71,	480,	6760,	6926068,	1820,	12,	Manufacturer("Boeing",	"US"),	1920,	""),
    ...
    Model("NAMC YS-11",	"Post-War Props",	64,	2,	0.97,	2.42,	469,	970,	12360130,	2600,	6,	Manufacturer("NAMC",	"JP"),	1210,	""),
    Model("Saab 2000",	"Saab Regional",	58,	5,	1.6,	2.23,	608,	2868,	10712907,	1820,	2,	Manufacturer("Saab",	"SE"),	1252,	"https://www.norebbo.com/saab-340b-blank-illustration-templates/"),
    ...
    Model("Sud Aviation Caravelle 12",	"Sud Aviation Caravelle",	140,	2,	2.32,	2.3,	810,	3200,	12342830,	1300,	4,	Manufacturer("Sud Aviation",	"FR"),	1310,	""),
    Model("Sud Aviation Caravelle III",	"Sud Aviation Caravelle",	80,	2,	2.44,	2.52,	845,	2100,	7237285,	1300,	4,	Manufacturer("Sud Aviation",	"FR"),	1270,	""),
    Model("Sukhoi Superjet 100",	"Sukhoi",	108,	6,	1.26,	1.76,	844,	4578,	37244467,	1300,	16,	Manufacturer("UAC",	"RU"),	1400,	"https://www.norebbo.com/2016/02/sukhoi-ssj-100-blank-illustration-templates/"),
    Model("Sukhoi Superjet 130NG",	"Sukhoi",	130,	6,	1.16,	1.91,	844,	4008,	36262861,	1300,	16,	Manufacturer("UAC",	"RU"),	1400,	"https://www.norebbo.com/2016/02/sukhoi-ssj-100-blank-illustration-templates/"),
    Model("Sukhoi KR-860",	"Sukhoi",	920,	5,	3.64,	1.65,	980,	8800,	303067034,	1300,	58,	Manufacturer("Sukhoi",	"RU"),	3500,	""),
    Model("Tupolev Tu-134",	"Tupolev 124",	72,	2,	2.81,	3.06,	850,	2200,	2933489,	1456,	12,	Manufacturer("Tupolev",	"RU"),	1450,	""),
    Model("Tupolev Tu-144",	"Tupolev 144",	183,	8,	4.07,	4.91,	2125,	6200,	191478910,	1144,	24,	Manufacturer("Tupolev",	"RU"),	3550,	""),
    Model("Tupolev Tu-154M",	"Tupolev 154",	180,	3,	1.69,	2.48,	850,	5280,	19510788,	1664,	12,	Manufacturer("Tupolev",	"RU"),	1250,	"https://www.norebbo.com/tupolev-tu-154-side-view/"),
    Model("Tupolev Tu-154",	"Tupolev 154",	180,	2,	1.74,	2.95,	850,	2500,	14141015,	1664,	12,	Manufacturer("Tupolev",	"RU"),	1140,	"https://www.norebbo.com/tupolev-tu-154-side-view/"),
    Model("Tupolev Tu-204–300",	"Tupolev 204",	156,	6,	1.67,	1.85,	820,	6452,	31890044,	1300,	18,	Manufacturer("Tupolev",	"RU"),	1650,	"https://www.norebbo.com/tupolev-tu-204-100-blank-illustration-templates/"),
    Model("Tupolev Tu-204-120",	"Tupolev 204",	210,	4,	1.5,	2.08,	820,	3800,	24887952,	1300,	18,	Manufacturer("Tupolev",	"RU"),	1870,	"https://www.norebbo.com/tupolev-tu-204-100-blank-illustration-templates/"),
    Model("Vickers VC10",	"Vickers",	150,	3,	2.96,	2.38,	930,	9410,	17566287,	1976,	12,	Manufacturer("Vickers-Armstrongs",	"GB"),	2520,	""),
    Model("Xi'an MA700",	"Xi'an Turboprop",	86,	6,	1.46,	2.28,	637,	1620,	15765674,	1300,	8,	Manufacturer("AVIC",	"CN"),	840,	""),
    ...
    Model("Zeppelin",	"Zeppelin",	148,	10,	1.15,	0.05,	155,	8000,	10900645,	1144,	12,	Manufacturer("Zeppelin Luftschifftechnik GmbH",	"DE"),	100,	""),
  )
